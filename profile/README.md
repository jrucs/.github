...
JRUCS is for playing trading card games.  It's a universal system that can be used and modified by anyone.  The cards themselves can be printed and modified.  This approach focuses games on creativity.
...
* [Gods](https://github.com/jrucs/gods)
